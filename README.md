...
- **source:** [public-apis/public-apis](https://github.com/public-apis/public-apis) — category: Continuous Integration

## API
- **Buddy** — [Documentation](https://buddy.works/docs/api/getting-started/overview)

## Tags
Continuous Integration, Public APIs
